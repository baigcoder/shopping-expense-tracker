...
(function () {
    ...
    const setExtensionFlag = async () => {
        try {
            ...
            try {
                ...
                localStorage.setItem('vibe_tracker_extension_auth', JSON.stringify(authData));
    ...
    // Refresh flags every 10 seconds to keep them fresh
    setInterval(setExtensionFlag, 10000);
