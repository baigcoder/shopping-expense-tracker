                ...
                <div className="flex min-w-0 flex-col items-center justify-start lg:justify-center px-4 py-28 sm:p-8 md:p-16 lg:p-12 xl:p-20 bg-white relative border-black lg:border-r-8 min-h-screen lg:h-full overflow-y-auto scrollbar-hide">
                    ...
                    >
                        <header className="space-y-4">
                            ...
                            <h2 className="text-4xl sm:text-5xl font-black italic uppercase tracking-tighter leading-none">SIGN_UP</h2>
                        ...
                        <div className="max-w-full overflow-hidden border-4 sm:border-8 border-black p-4 sm:p-10 bg-white shadow-[5px_5px_0px_#000000] sm:shadow-[16px_16px_0px_#000000] relative">
                            ...
                            <form onSubmit={handleSignup} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            className={cn(
                                                "w-full h-14 border-4 border-black bg-white pl-12 sm:pl-16 pr-4 sm:pr-8 font-black uppercase text-[11px] sm:text-xs focus:bg-black focus:text-white transition-all outline-none",
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={cn(
                                                "w-full h-14 border-4 border-black bg-white pl-12 sm:pl-16 pr-12 sm:pr-16 font-black uppercase text-[11px] sm:text-xs focus:bg-black focus:text-white transition-all outline-none",
                                ...
                                <button 
                                    type="submit" 
                                    disabled={isLoading}
                                    className="w-full h-16 bg-black text-white font-black uppercase text-xs sm:text-sm hover:bg-[#E11D48] transition-colors shadow-[5px_5px_0px_#E11D48] sm:shadow-[8px_8px_0px_#E11D48] disabled:opacity-50 flex items-center justify-center gap-3 sm:gap-4 group mt-4"
                                >
                                    {isLoading ? (
                            ...
                            <button 
                                ...
                                disabled={isLoading}
                                className="w-full min-h-14 border-4 border-black bg-white hover:bg-black hover:text-white transition-all font-black uppercase text-[9px] min-[380px]:text-[10px] tracking-[0.08em] flex items-center justify-center gap-3 px-3"
                            >
