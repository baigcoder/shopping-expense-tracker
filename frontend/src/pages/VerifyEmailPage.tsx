    ...
    return (
        <div className="min-h-screen bg-white flex items-center justify-center p-4 sm:p-8 font-bold selection:bg-black selection:text-white overflow-x-hidden">
            ...
            >
                {status === 'loading' && (
                    <div className="text-center space-y-8">
                        ...
                        <div className="space-y-2">
                            <h2 className="text-3xl sm:text-4xl font-black italic uppercase tracking-tighter break-words">VERIFYING_EMAIL</h2>
                ...
                {status === 'error' && (
                    <div className="text-center space-y-10">
                        <div className="w-20 h-20 sm:w-24 sm:h-24 border-4 sm:border-8 border-black flex items-center justify-center mx-auto bg-[#E11D48] text-white">
                            <AlertCircle className="h-12 w-12" strokeWidth={4} />
                        </div>
                        <div className="space-y-4">
                            <h2 className="text-3xl sm:text-4xl font-black italic uppercase tracking-tighter break-words">VERIFICATION_FAILED</h2>
                            <p className="text-xs font-black uppercase tracking-widest opacity-60">
